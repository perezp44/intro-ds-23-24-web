...
-   **Tutoriales** : digamos que son los apuntes/libro oficial del curso. Tenéis que ir leyéndolos poco a poco. Algunas de las tareas a hacer en casa consistirán en leer secciones de estos tutoriales. 

-   **Guiones de clase/Ejemplos/Ejercicios** : cada sesión del curso tendrá un guión asociado con los materiales a usar en esa clase. Los iré colgando conforme avancen las clases.
...
- [Slides-05: Data munging](./materiales/slides_05_data-munging.html){target="_blank"}
...
- [Week 01](./guiones/guion_week_01.zip){target="_blank"} 

- [Week 03](./guiones/week_03.zip){target="_blank"} 

- [Week 07](./guiones/week_07.zip){target="_blank"} 

<br>

## Plantillas para los trabajos

- [Plantillas para trabajos individuales y en equipo](./guiones/plantillas_BigData_2023.zip){target="_blank"} 
